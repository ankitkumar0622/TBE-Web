...
const NodeQuestions = ({ seoMeta }: PageProps) => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await axios.get(`${routes.interviewPrepGetAll}?type=Node`);
  ...
  const handleCreateQuestion = async () => {
    ...
    try {
      ...
      setNewQuestion({ name: '', answer: '', type: 'Node' });
      setError(null);
    } catch (error) {
  ...
  return {
    props: {
      seoMeta: {
        ...
        description: 'A collection of Node.js interview questions to help you prepare.',
        url: routes.interviewPrepNode,
        robots: 'follow, index',
      },
    },
  };
